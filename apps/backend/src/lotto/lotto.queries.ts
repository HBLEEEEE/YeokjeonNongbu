export const lottoQueries = {
  ...
  findUnsoldPosition:
    'SELECT ticket_id, rank FROM tickets WHERE check = false ORDER BY ticket_id ASC LIMIT 1',
  checkToTrue: 'UPDATE tickets SET check = true WHERE ticket_id = ($1)',
  ...
  updateLottoHistory: 'UPDATE lottos SET $1 = $1 + 1 WHERE member_id = $2'
};
